...
export default function CheatSheet() {
  ...
  const data = [
    Pulley("VEXPro, WCP", "#25", 16, '3/8" Hex'),
    Pulley("VEXPro, WCP", "#25", 18, '3/8" Hex'),
    Pulley("VEXPro, WCP", "#25", 22, '3/8" Hex'),
    Pulley("VEXPro, WCP", "#25", 16, '1/2" Hex'),
    Pulley("VEXPro, WCP", "#25", 18, '1/2" Hex'),
    Pulley("VEXPro, WCP", "#25", 22, '1/2" Hex'),
    Pulley("VEXPro, WCP", "#25", 16, '1/2" ID'),
    Pulley("VEXPro, WCP", "#25", 22, '1/2" ID'),
    Pulley("VEXPro, WCP", "#25", 32, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 34, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 36, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 38, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 40, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 42, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 44, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 48, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 54, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 58, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 60, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 64, '1-1/8" Bearing Bore'),
    Pulley("VEXPro, WCP", "#25", 66, '1-1/8" Bearing Bore'),
      ...
      <table className="table is-hoverable is-narrow">
        ...
        <tbody>
          {data.map((pulley) => {
            return (
              <tr
                key={pulley.vendor + pulley.teeth + pulley.bore + pulley.type}
              >
                <td>{pulley.vendor}</td>
                <td>{pulley.chain}</td>
