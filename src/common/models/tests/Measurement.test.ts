...
describe("Measurement", () => {
  ...
  describe("Math functions map to inner Qty functions", () => {
    test.each([
      ...
      [
        ...
        new Measurement(22.23, "lbs"),
      ],
      [new Measurement(1, "in"), 3, new Measurement(4, "in")],
    ])("%p Add", (a, b, result) => {
    ...
    test.each([
      ...
      [new Measurement(5, "in"), 3, new Measurement(2, "in")],
    ])("%p Sub", (a, b, result) => {
    ...
    test.each([
      ...
      expect(a).toBeLessThanOrEqualToMeasurement(b);
    });
    ...
    test.each([
      ...
      expect(b).toBeGreaterThanOrEqualToMeasurement(a);
    });
  });
  ...
  test.each([[new Measurement(1, "A*V"), new Measurement(1, "A*m2*kg/s3*A")]])(
