...
export class MotorRules {
  ...
  solve(): CompleteMotorState {
    ...
    const losses = this.rulesState
      .current!.mul(this.rulesState.current!)
      .mul(this.rulesState.motor.resistance)
      .add(this.rulesState.voltage!.mul(this.rulesState.motor.freeCurrent));
