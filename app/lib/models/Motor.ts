...
export const ALL_MOTORS: MotorSpecs[] = [
  ...
  },
  {
    ...
    motorWeight: new Measurement(0.806, 'lb'),
    controllerWeight: SPARK_MAX_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
    vendors: ['AndyMark'],
  ...
  },
  {
    ...
    motorWeight: new Measurement(2.8, 'lb'),
    controllerWeight: SPARK_MAX_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
    vendors: ['AndyMark'],
  ...
  },
  {
    ...
    motorWeight: new Measurement(2.16, 'lb'),
    controllerWeight: SPARK_MAX_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
    vendors: ['VEX'],
  ...
  },
  {
    ...
    motorWeight: new Measurement(0.71, 'lb'),
    controllerWeight: SPARK_MAX_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
    vendors: ['VEX'],
  ...
  },
  {
    ...
    motorWeight: new Measurement(0.55, 'lb'),
    controllerWeight: SPARK_MAX_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
    vendors: ['AndyMark'],
  ...
  },
  {
    ...
    motorWeight: new Measurement(0.74, 'lb'),
    controllerWeight: SPARK_MAX_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
    vendors: ['BaneBots'],
  ...
  },
  {
    ...
    motorWeight: new Measurement(1.1, 'lb'),
    controllerWeight: SPARK_MAX_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
    vendors: ['AndyMark'],
  ...
  },
  {
    ...
    motorWeight: new Measurement(0.587, 'lb'),
    controllerWeight: NO_CONTROLLER_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
    vendors: ['AndyMark'],
  ...
  },
  {
    name: 'HD Hex',
    voltage: new Measurement(12, 'V'),
    stallTorque: new Measurement(0.182, 'N*m'),
    stallCurrent: new Measurement(11, 'A'),
    freeCurrent: new Measurement(0.4, 'A'),
    freeSpeed: new Measurement(5960, 'rpm'),
    motorWeight: new Measurement(0.516, 'lb'),
    controllerWeight: NO_CONTROLLER_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
    vendors: ['REV'],
  ...
  },
  {
    ...
    motorWeight: new Measurement(0.4375, 'lb'),
    controllerWeight: NO_CONTROLLER_WEIGHT,
    type: 'Brushed',
    dataSource: 'REV',
    vendors: ['REV'],
  ...
  },
  {
    ...
    motorWeight: new Measurement(0.545, 'lb'),
    controllerWeight: NO_CONTROLLER_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
    vendors: [],
  ...
  // Motor curve endpoints estimated by linearly extending the VEX-provided curves.
  // Green and blue motors use the equivalent cartridge ratios. See:
  // https://www.vexforum.com/t/v5-smart-motor-estimating-performance-parameters/135200
  {
    name: 'V5 Smart Motor (Red)',
    voltage: new Measurement(12, 'V'),
    stallTorque: new Measurement(3.99, 'N*m'),
    stallCurrent: new Measurement(4.686, 'A'),
    freeCurrent: new Measurement(0.13982, 'A'),
    freeSpeed: new Measurement(120.909, 'rpm'),
    motorWeight: new Measurement(0.342, 'lb'),
    controllerWeight: NO_CONTROLLER_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
    vendors: ['VEX'],
  ...
  {
    name: 'V5 Smart Motor (Green)',
    voltage: new Measurement(12, 'V'),
    stallTorque: new Measurement(1.995, 'N*m'),
    stallCurrent: new Measurement(4.686, 'A'),
    freeCurrent: new Measurement(0.13982, 'A'),
    freeSpeed: new Measurement(241.818, 'rpm'),
    motorWeight: new Measurement(0.342, 'lb'),
    controllerWeight: NO_CONTROLLER_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
  ...
  {
    name: 'V5 Smart Motor (Blue)',
    voltage: new Measurement(12, 'V'),
    stallTorque: new Measurement(0.665, 'N*m'),
    stallCurrent: new Measurement(4.686, 'A'),
    freeCurrent: new Measurement(0.13982, 'A'),
    freeSpeed: new Measurement(725.454, 'rpm'),
    motorWeight: new Measurement(0.342, 'lb'),
    controllerWeight: NO_CONTROLLER_WEIGHT,
    type: 'Brushed',
    dataSource: 'VEX',
